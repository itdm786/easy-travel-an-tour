...
export const metadata: Metadata = {
  title: "Visa Requests | Easy Travel Admin",
...
export default async function AdminVisaRequestsPage() {
  ...
  const rows = await getServiceRequests("visa");
  ...
  return (
    <AdminShell
      ...
      role={session.role}
      title="Visa Requests"
      description="Website ke Visa Services page se aane wali requests yahan track karein."
    >
      <ServiceRequestManager
        initialRequests={initialRequests}
        emptyMessage="Koi visa request abhi tak nahi aayi."
      />
    </AdminShell>
  );
}
